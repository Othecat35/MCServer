...
#Functions
def get_project_build(project_name: str, game_version: str, build_id: int | Literal["latest"] = "latest") -> ProjectBuild:
    response = networking.request(f"{papermc_api_url}/v3/projects/{project_name}/versions/{game_version}/builds/{build_id}")
